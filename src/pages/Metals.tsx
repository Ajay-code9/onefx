    ...
    <div className="site-container">
      ...
      <div className="grid md:grid-cols-3 gap-12">
        {[
          ...
          >
            <div className="text-[120px] font-bold text-white/5 absolute -top-16 left-1/2 -translate-x-1/2 md:-left-4 md:translate-x-0 pointer-events-none group-hover:text-gold/10 transition-colors select-none">
              {item.step}
            </div>
