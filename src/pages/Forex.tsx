  ...
  <section className="site-section bg-[linear-gradient(180deg,#13032a_0%,#09021b_58%,#090118_100%)] relative overflow-hidden">
    ...
    <div className="site-container relative z-10">
      <div className="text-center max-w-4xl mx-auto mb-10">
        <h2 className="site-heading font-bold text-white mb-6">Why Trade Forex With oneFX</h2>
      </div>
  ...
  <section className="site-section bg-[#050510]">
    <div className="site-container">
      <div className="text-center mb-20">
        <h2 className="site-heading font-bold text-white mb-6">Currency Strength Heatmap</h2>
  ...
  <section className="site-section bg-dark">
    <div className="site-container">
      <div className="text-center max-w-3xl mx-auto mb-20">
        <h2 className="site-heading font-bold text-white mb-6">Forex Trading FAQs</h2>
